...
<a class="btn btn-sm fw-bold btn-primary" type="button" href="{{ route('categories.new') }}">New Category</a>
@endcan
@can('categories.export')
<a class="btn btn-sm fw-bold btn-primary" type="button" href="{{ route('categories.export') }}">Export Categories</a>
@endcan
@endsection
