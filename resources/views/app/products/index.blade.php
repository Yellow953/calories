...
@section('actions')
@can('products.create')
<a class="btn btn-sm fw-bold btn-primary" type="button" href="{{ route('products.new') }}">New Product</a>
@endcan
@can('products.export')
<a class="btn btn-sm fw-bold btn-primary" type="button" href="{{ route('products.export') }}">Export Products</a>
@endcan
@endsection
